...
- [ ] **B9 (NAYA, aaj mila). Flex quote-accept par RATE ka unit galat** — "15 × ₹27/mo" dikhta hai jabki asli ₹325/seat/month hai (monthly-billing display 12 se bhaag deta hai, flex ka rate PEHLE se monthly hai). Line/total sahi; sirf unit-display. `quote-accept-view.tsx` ka fmtInv/scheduleLabel raasta.
