...
--
-- All five are nullable with no default. A lead typed in by hand has no landing
...
-- Expect: expenses.channel = 1 · leads utm columns = 5 · indexes = 2
-- ============================================================================
/*
...
union all
select 'leads utm columns', count(*)
  from information_schema.columns
 where table_schema = 'public' and table_name = 'leads'
   and column_name in ('utm_source','utm_medium','utm_campaign','referrer_url','landing_page_url')
union all
select 'new indexes', count(*)
  from pg_indexes
 where schemaname = 'public' and indexname in ('expenses_channel_idx','leads_utm_source_idx');
*/
