...
async function executeSqlViaManagement() {
  ...
  console.log("Sending DDL statement to Supabase REST endpoint...");

  // Try calling pg_net or rpc if available, or fetch via postgres API
  ...
  if (res && res.ok) {
    console.log("✅ SQL executed via Supabase Management API!");
  } else {
